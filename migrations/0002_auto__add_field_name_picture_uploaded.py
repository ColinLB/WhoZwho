...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Name.picture_uploaded'
        db.add_column('WhoZwho_name', 'picture_uploaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Name.picture_uploaded'
        db.delete_column('WhoZwho_name', 'picture_uploaded')
