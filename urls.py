...
urlpatterns = patterns('',
    ...
    url(r'^single/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',              'WhoZwho.DirectoryDescribeFamily.singleparent'),
    url(r'^parents/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',             'WhoZwho.DirectoryDescribeFamily.parents'),
