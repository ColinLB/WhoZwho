...
urlpatterns = patterns('',
    ...
    url(r'^cia/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',                 'WhoZwho.DirectoryAddresses.CreatePersonal'),
    url(r'^eia/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',                 'WhoZwho.DirectoryAddresses.EditPersonal'),
    url(r'^sia/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',                 'WhoZwho.DirectoryAddresses.PersonalMenu'),
    ...
    url(r'^personal/(?P<nid>\d+)/(?P<browser_tab>[a-zA-Z]+)$',            'WhoZwho.DirectoryDescribeFamily.personal'),
